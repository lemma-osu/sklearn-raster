...
- Migrate build system and developer tooling from Hatch to uv
...
- Fix error that prevented using a boolean scalar `nodata_input` with a boolean feature array
...
[unreleased]: https://github.com/lemma-osu/sklearn-raster/compare/v0.1.0.dev2...HEAD
[0.1.0.dev2]: https://github.com/lemma-osu/sklearn-raster/compare/v0.1.0.dev1...v0.1.0.dev2
